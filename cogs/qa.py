...
class QA(commands.Cog):
    ...
    async def question(self, ctx, *, question):
        emb = discord.Embed(title=f"New question from {ctx.author}", description=question, color=discord.Color.blue())
        ...
        await thread.send(embed=discord.Embed(title="Answers", description="Answer to "+ctx.author.mention, color=discord.Color.brand_green()))
